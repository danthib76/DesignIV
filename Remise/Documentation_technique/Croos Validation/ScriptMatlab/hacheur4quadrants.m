A = hacheur4quadrants.signals(1).values(:,2);
...
figure(1)
subplot(4,1,1)
plot(Time,IMagnet,hacheur4quadrants.time, A,Time,IRef)
legend('PSIM','SPS','REF')
xlim([0,0.9]);
ylim([-1000,7000])
...
figure(2)
subplot(2,1,1)
plot(Time,VMagnet,hacheur4quadrants.time,hacheur4quadrants.signals(2).values(:,1) )
legend('PSIM','SPS')
xlim([0,0.9])
xlabel('Temps (sec)','FontSize',15)
...
figure(3)
subplot(2,1,1)
plot(Time,DCNIigbt,hacheur4quadrants.time,hacheur4quadrants.signals(5).values(:,1) )
legend('PSIM','SPS')
xlim([0,0.9])
ylim([-1000,7000])
xlabel('Temps (sec)','FontSize',15)
