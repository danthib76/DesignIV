\chapter{Validation croisée entre les simulateurs PSIM et SPS}
...
\begin{figure}
\makebox[\textwidth][c]{\includegraphics[scale=0.7]{Fig/Comp/improving_performance5.png}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/Comp/IGBT.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/Comp/PI.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/H4Q.png}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/Hacheur4Quadrants/HacheurCourantCharge1u.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/Hacheur4Quadrants/HacheurTensionCharge1u.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/Hacheur4Quadrants/HacheurCourantIGBT1u.jpg}}
\caption{Courant traversant un IGBT sur PSIM et SPS pour un pas de calcul de 1$\mu$s, pour le hacheur 4 quadrants}
\label{hc_IG_cou_1}
\end{figure}

\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/Hacheur4Quadrants/HacheurTensionIGBT1u.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.75]{fig/DCP_DCN.png}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/DCPDCN/DCPCourantCharge1u.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/DCPDCN/DCPTensionCharge1u.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/DCPDCN/DCPCourantIGBT1u.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/DCPDCN/DCPTensionIGBT1u.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.6]{fig/AFE_IDEAL.png}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/AFEIDEAL/CourantAC.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/AFEIDEAL/pui45.jpg}}
\caption{Puissances active et réactive pour une courant déphasé de 45$^\circ$, pour un pas de calcul 1$\mu$s}
\label{AF_I_pui_45}
\end{figure}

\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/AFEIDEAL/pui135.jpg}}
\caption{Puissances active et réactive pour une courant déphasé de 135$^\circ$, pour un pas de calcul 1$\mu$s}
\label{AF_I_pui_135}
\end{figure}

\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/AFEIDEAL/pui_45.jpg}}
\caption{Puissances active et réactive pour une courant déphasé de -45$^\circ$, pour un pas de calcul 1$\mu$s}
\label{AF_I_pui__45}
\end{figure}

\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/AFEIDEAL/pui_135.jpg}}
\caption{Puissances active et réactive pour une courant déphasé de -135$^\circ$, pour un pas de calcul 1$\mu$s}
\label{AF_I_pui__135}
\end{figure}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.6]{fig/AFE_2L_RC.png}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/AFERC/FFTAnalysisToolResult5u.png}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/AFERC/cour_al.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/AFERC/vch.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/AFERC/IGBT.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.6]{fig/AFE_3L_RC.png}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/AFE3LEVEL/1u/cour_al.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/AFE3LEVEL/1u/vch.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/AFE3LEVEL/1u/IGBT.jpg}}
\caption{La tension et le courant au niveau d'un IGBT pour un pas de calcul de 1$\mu$s, pour l'AFE 3 niveaux}
\label{AF_3_IGBT}
\end{figure}

\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/AFE3LEVEL/1u/DIODE.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.6]{fig/H4Q_AFE_2L_RC.png}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/Hach_AFE/1u/cour_al.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/Hach_AFE/1u/ten_bus.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/Hach_AFE/1u/IGBT_AFE.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/Hach_AFE/1u/hach_cou_ch.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/Hach_AFE/1u/hach_ten_ch.jpg}}
\caption{La tension au niveau de la charge à 1$\mu$s}
\label{AF_HA_CHV1}
\end{figure}

\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/Hach_AFE/1u/IGBT_cou_hach.jpg}}
\caption{Le courant aux bornes d'un IGBT à 1$\mu$s pour le hacheur 4 quadrants}
\label{AF_HA_HAA1}
\end{figure}

\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/Hach_AFE/1u/IGBT_ten_hach.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.6]{fig/AFE_3L_RC_DCP_DCN.png}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/DCP_AFE/1u/cour_al.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/DCP_AFE/1u/ten_ligne_ligne.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/DCP_AFE/1u/ten_bus.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/DCP_AFE/1u/IGBT_afe.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/DCP_AFE/1u/cou_IGBT_afe.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/DCP_AFE/1u/ten_diode_afe.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/DCP_AFE/1u/cou_diode_afe.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/DCP_AFE/1u/cour_ch.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/DCP_AFE/1u/ten_ch.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/DCP_AFE/1u/hash_cou_IGBT.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/DCP_AFE/1u/hash_ten_IGBT.jpg}}
...
\begin{figure}[htb]
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/DCP_AFE/1u/hash_diode_cou.jpg}}
