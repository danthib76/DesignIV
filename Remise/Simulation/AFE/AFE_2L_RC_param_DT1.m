...
%Continuous phase PI controller for Load voltage control tuned manually
PIcont3 = tf([0.48,8],[1,0]);
% Discretization of PI in z with Tstep
PIdisc3=c2d(PIcont3,Tpas);
% Calcul des coeff PI du PI discret de simulink
[Numd3,Dend3,Ts3]=tfdata(PIdisc3, 'v');
P3=Numd3(1)/Dend3(1);
I3=(P3+Numd3(2)/Dend3(1))/Ts3;