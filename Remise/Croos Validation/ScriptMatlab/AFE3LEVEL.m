...
figure(3)
subplot(2,1,1)
plot(Time,S3Vigbt,AFE3LEVEL.time,IGBT.signals.values(:,2))
xlabel('Temps (sec)','FontSize',15)
ylabel('Tension (V)','FontSize',15)
...
%Courant IGBT
subplot(2,1,2)
plot(Time,IS3IGBT1,AFE3LEVEL.time,IGBT.signals.values(:,1))
xlabel('Temps (sec)','FontSize',15)
ylabel('Courant (A)','FontSize',15)
...
figure(4)
subplot(2,1,1)
plot(Time,S3Vdiode*-1,AFE3LEVEL.time,DIODE.signals.values(:,2))
xlabel('Temps (sec)','FontSize',15)
ylabel('Tension (V)','FontSize',15)
...
%Courant Diode
subplot(2,1,2)
plot(Time,IS3D1,AFE3LEVEL.time,DIODE.signals.values(:,1))
xlabel('Temps (sec)','FontSize',15)
ylabel('Courant (A)','FontSize',15)
