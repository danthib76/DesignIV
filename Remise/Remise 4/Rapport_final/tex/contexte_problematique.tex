...
\begin{figure}[htb]
\centering
\makebox[\textwidth][c]{\includegraphics[scale=0.8]{BOOSTER.png}}
...
\begin{figure}[htb]
\centering
\makebox[\textwidth][c]{\includegraphics[scale=0.75]{fig/3L_Line_Voltage.png}}
...
\begin{figure}[htb]
\centering
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/Iref.png}}
...
\begin{figure}[htb]
\centering
\makebox[\textwidth][c]{\includegraphics[scale=0.5]{fig/entrelacage.png}}
